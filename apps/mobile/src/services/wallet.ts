...
const WALLET_ADDRESS_KEY = "stockpile_wallet_address";
const GRID_USER_ID_KEY = "stockpile_grid_user_id";
const AUTH_USER_ID_KEY = "stockpile_auth_user_id";
const ONBOARDING_KEY = "stockpile_onboarding_complete";
